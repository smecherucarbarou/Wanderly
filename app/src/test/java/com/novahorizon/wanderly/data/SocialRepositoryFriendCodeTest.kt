...
class SocialRepositoryFriendCodeTest {
    ...
    @Test
    fun `normalize friend code rejects blank and empty`() {
        assertNull(SocialRepository.normalizeFriendCode(""))
        assertNull(SocialRepository.normalizeFriendCode("   "))
    }

    @Test
    fun `normalize friend code rejects too long`() {
        assertNull(SocialRepository.normalizeFriendCode("ABCDEFG"))
    }
}
